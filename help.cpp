...
void GameplayHelp(){
    ...
    cout << "Both players should receive random items with random quantity (can be 0)." << endl;
    ...
    // End game
    cout << "The game continues until one of the players reached the life total of 0 or below." << endl;
...
void ItemsHelp(){
    cout << "Item phase is a phase when a player decide to use items.\n" << endl;
    ...
    cout << "Magnet: Steal 1 item from another player\n" << endl;
